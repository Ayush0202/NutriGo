  ...
  return (
    <>
        ...
        <Box>
            ...
            {/* logo */}
            <img src={logo} alt='logo' style={{width: '300px', height: 'auto', padding:'50px'}} />
            ...
            {data && data.length > 0 && (
                <h2 style={{color: '#AFE1AF', fontSize:'40px'}}>
                    {data && data[0].name && data[0].name.charAt(0).toUpperCase() + data[0].name.slice(1)} has a total of <span style={{color: '#355E3B'}}>{data && data[0].calories} calories</span>
                </h2>
            )}
            ...
            {data && data.length > 0 && <Box sx={{ 
              ...
              <Grid container spacing={6}>
                ...
                {data && <Grid item xs={12} sm={12} md={6} >
                    {data && data.length > 0 && <Exercise
