...
const Exercise = (props) => {
  return (
    <>
        ...
        <h4 style={{color:'black', fontSize:'20px', textAlign:'left'}}>To burn {props.calories} calories you will have to</h4>
        ...
        <Box sx={{ flexGrow: 1, marginBottom:'50px'}}>
            <Grid container spacing={1} columns={16}>
                ...
                <Grid item xs={12} style={{textAlign:'left', marginTop:'-20px'}}>
                        ...
                        <p style={{color:'black', marginTop:'-10px'}}>You will have to jog for {props.jog} minutes</p>
                </Grid>
            </Grid>
        </Box>
        ...
        <Box sx={{ flexGrow: 1, marginBottom:'50px'}}>
            <Grid container spacing={1} columns={16}>
                ...
                <Grid item xs={12} style={{textAlign:'left', marginTop:'-20px'}}>
                        ...
                        <p style={{color:'black', marginTop:'-10px'}}>You will have to Power Yoga for {props.powerYoga} minutes</p>
                </Grid>
            </Grid>
        </Box>
        ...
        <Box sx={{ flexGrow: 1, marginBottom:'50px'}}>
            <Grid container spacing={1} columns={16}>
                ...
                <Grid item xs={12} style={{textAlign:'left', marginTop:'-20px'}}>
                        ...
                        <p style={{color:'black', marginTop:'-10px'}}>You will have to Gym for {props.gym} minutes</p>
                </Grid>
            </Grid>
        </Box>
        ...
        <Box sx={{ flexGrow: 1, marginBottom:'50px'}}>
            <Grid container spacing={1} columns={16}>
                ...
                <Grid item xs={12} style={{textAlign:'left', marginTop:'-20px'}}>
                        ...
                        <p style={{color:'black', marginTop:'-10px'}}>You will have to Brisk Walk for {props.walk} minutes</p>
                </Grid>
            </Grid>
        </Box>
